...
Dr. Metaxas has published over 500 research papers, graduated 42 Ph.D. students, and received funding from agencies including NSF, NIH, DARPA, and ONR. His contributions to fluid modeling helped pioneer animation techniques used in the film Antz. He is a Fellow of IEEE and AIMBE, a recipient of multiple prestigious awards, and has served as chair for top conferences such as ICCV, CVPR, and MICCAI.`
}

export default mockPiData;